...
class Device(Base):
    ...
    dc_power_draw_amps: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    pdu_a_id: Mapped[Optional[int]] = mapped_column(ForeignKey("pdus.id", ondelete="SET NULL"), nullable=True, index=True)
    pdu_b_id: Mapped[Optional[int]] = mapped_column(ForeignKey("pdus.id", ondelete="SET NULL"), nullable=True, index=True)
...
class VisionSession(Base):
    ...
    layout_review_json: Mapped[str] = mapped_column(Text, default="")
    created_by: Mapped[Optional[int]] = mapped_column(ForeignKey("users.id"), nullable=True)
...
class VisionProposal(Base):
    ...
    confirmed_fields_json: Mapped[str] = mapped_column(Text, default="[]")
    skipped_fields_json: Mapped[str] = mapped_column(Text, default="[]")
